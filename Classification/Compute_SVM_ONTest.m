function [Accuracy,ConMat,FValue_SVM,PostProbs,Newlabels,NewLabels_Ind,Flag] = Compute_SVM_ONTest(Trained_Model,Feature,Label,Ind_Train,Ind_Test) 
...
%     CompactSVMModel = fitSVMPosterior(Trained_Model,Feature(Ind_Train,:),Label(Ind_Train)); 
% 
%     [Newlabels,PostProbs] = predict(CompactSVMModel,Feature(Ind_Test,:));  % this line will predict labels for test data set and their posterior probability 
